        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <button class="dataTables_length btn btn-primary fa fa-plus" style="margin-right: 10px" data-toggle="modal" data-target="#tambah" data-toggle="tooltip" title="Tambah Data"></button>
                    <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama Kelompok</th>
                    ...
                    <tr class="gradeX">
                        ...
                        <td><?php echo $row->tentatif;?></td>
                        <td><?php echo $row->definitif;?></td>
                        <td><?php echo $row->roadmap;?></td>
                        <td><?php echo $row->lpj;?></td>
                         <td><a href="<?php echo base_url()?>Mahasiswa/hapus_pelaporan/<?php echo $row->id_pelaporan ?>"><button class="btn-danger btn fa fa-trash"></button></a></td>
                    </tr>
                    <?php }?>
                    </tbody>
                    </table>
          ...
          <div  aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tambah" class="modal fade">
                        ...
                        <div class="modal-header">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo site_url('Mahasiswa/upload_pelaporan')?>" enctype="multipart/form-data>
                                    ...
                                    <div class="form-group">
                                        ...
                                        echo "<input style='margin-left: 60px' name='tentatif1' type='hidden' value='Tentantif_".$kel->nama_kelompok."'>";
                                        echo "<input style='margin-left: 60px' name='definitif1' type='hidden' value='Definitif_".$kel->nama_kelompok."'>";
                                        echo "<input style='margin-left: 60px' name='roadmap1' type='hidden' value='Roadmap_".$kel->nama_kelompok."'>";
                                        echo "<input style='margin-left: 60px' name='lpj1' type='hidden' value='LPJ_".$kel->nama_kelompok."'>";
                                        ?>

                                        <!-- Pisah- -->
                                        <label style="margin-top: 20px;" class="col-sm-2 control-label">Tentatif</label>
                                        <input style="margin-left: 150px;margin-top: 10px; " name="tentatif" type="file">
                                        ...
                                        <input style="margin-left: 150px;margin-top: 10px; " name="definitif" type="file">
                                        <span  style="margin-left: 150px;margin-top: 10px" class="help-block m-b-none">(Sudah di tanda tangan dpl)</span>
                                        <div class="hr-line-dashed"></div>
                                        
                                        <!-- Pisah- -->
                                        <label style="margin-top: 20px;" class="col-sm-2 control-label">Roadmap</label>
                                        <input style="margin-left: 150px;margin-top: 10px; " name="roadmap" type="file">
                                        <span  style="margin-left: 150px;margin-top: 10px" class="help-block m-b-none">(Sudah di tanda tangan dpl)</span>
                                        <div class="hr-line-dashed"></div>
                                        
                                        <!-- Pisah- -->
                                        <label style="margin-top: 20px;" class="col-sm-2 control-label">LPJ</label>
                                        <input style="margin-left: 150px;margin-top: 10px; " name="lpj" type="file">
                                        <span  style="margin-left: 150px;margin-top: 10px" class="help-block m-b-none">(Sudah di tanda tangan dpl)</span>
                                        <div class="hr-line-dashed"></div>
                                    </div>
                                    </div>
