...
<body>
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="<?php echo site_url('Mahasiswa/penilaian_kormades') ?>">Penilaian Kelompok</a></li>
                            <li><a href="<?php echo base_url('Mahasiswa/daftar_nilai') ?>">Daftar Penilaian</a></li>
                            <li><a href="<?php echo site_url('Mahasiswa/lokasi_kelompok') ?>">Input Lokasi Kelompok</a></li>
        ...
        <div class="row">
                    <a href="<?php echo base_url('Mahasiswa/status_pelaporan')?>">
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <?php if($laporan_diterima_dpl == 1){
                                echo "<h1 class='no-margins'>Diterima DPL</h1>";
                                }else if($laporan_diterima_lppm == 1){
                                echo "<h1 class='no-margins'>Diterima LPPM</h1>";    
                                }else if($laporan_diperbaiki == 1){
                                echo "<h1 class='no-margins'>diperbaiki</h1>";
                                }else if($laporan_cek == 0){
                                echo "<h1 class='no-margins'>Belum ada pelaporan</h1>";
                                }else{
                                    echo "<h1 class='no-margins'>Pending</h1>";
                                    }?>
                                <br><br>
                                <div class="stat-percent font-bold text-success"><i class="fa fa-send"></i></div>
                    ...
                    <a href="<?php echo base_url('Mahasiswa/penilaian_kormades')?>">
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-info pull-right">Anggota Kelompok</span>
                                <h5>Penilaian</h5>
                            </div>
                            <div class="ibox-content">
                                <h2 class="no-margins">(<?php echo $jumlah_anggota?>) Anggota </h2>
                                <h2 class="no-margins">Kelompok</h2>
                                <br>
                                <div class="stat-percent font-bold text-info"><i class="fa fa-group"></i></div>
                                <small> <?php echo $kelompok?> </small>
                            </div>
                        </div>
                    </div>
                    </a>

                    <a href="<?php echo base_url('Mahasiswa/lihat_lokasi_kelompok')?>">
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-primary pull-right">Posko Kelompok</span>
                                <h5>Lokasi</h5>
                            </div>
                            <div class="ibox-content">
                                ...
                                <div class="stat-percent font-bold text-navy"><i class="fa fa-map-marker"></i></div>
                                <small>Lokasi</small>
                            </div>
                        </div>
                    </div>
