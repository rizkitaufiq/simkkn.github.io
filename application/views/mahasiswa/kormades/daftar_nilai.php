                ...
                <li>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li class="active"><a href="<?php echo base_url('Mahasiswa/daftar_nilai') ?>">Daftar Penilaian</a></li>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr class="gradeX">
                        ...
                        <td>
                         <a href="<?php echo base_url()?>Mahasiswa/hapus_penilaian/<?php echo $row->id_penilaian ?>" onclick="return confirm('Anda yakin ingin menghapus data ini ?')"><button class="btn-danger btn fa fa-trash"></button></a>
                        </td>
                    </tr>
                    <?php }?>
                    </tbody>
