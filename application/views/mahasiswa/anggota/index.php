            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            ...
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Anggota</strong>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li class="active"><a href="<?php echo base_url('Mahasiswa/anggota') ?>">Penilaian Kelompok</a></li>
                            <li><a href="<?php echo base_url('Mahasiswa/anggota_daftar_nilai') ?>">Daftar Penilaian</a></li>
                        </ul>
                    </li>
        </div>
    </nav>
                    ...
                    <?php }?>
                     ...
                     <div id="input" class="modal fade" role="dialog">
                            ...
                            <div class="modal-header">
                                ...
                                <form method="post" action="<?php echo site_url('Mahasiswa/a_input_nilai')?>">
