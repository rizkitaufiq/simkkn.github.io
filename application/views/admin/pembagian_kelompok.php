...
<body>
                ...
                <li>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li class="active"><a href="<?php echo site_url('Lppm/pembagian_kelompok')?>">Pembagian kelompok</a></li>
            ...
            <div class="row">
                ...
                <div  aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="konfirmasi" class="modal fade">
                        ...
                        <div class="modal-header">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo site_url('Lppm/pembagian_kelompok_kkn')?>">
                                    <div class="modal-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nama Mahasiswa</label>
                                        <input type="hidden" id="id_peserta" name="id_peserta">
                                        <input class="form-control" style="margin-left: 60px;margin-left: 145px;width: 50%"" name="nama_mahasiswa" readonly="" type="text" id="nama_mahasiswa" value="<?php echo $row->nama_mahasiswa ?>" ></span>
                                        ...
                                        <input class="form-control" style="margin-top: 20px;margin-left: 145px;width: 50%" readonly="" name="nim" id="nim" type="text" value="<?php echo $row->nim?>">
                                        ...
                                        <input class="form-control" style="margin-top: 20px; margin-left: 145px;width: 50%" type="text" readonly="" value="<?php echo $row->jenis_kkn?>">
                                        ...
                                        <input class="form-control" style="margin-top: 20px; margin-left: 145px;width: 50%" type="text" readonly="" id="kabupaten" value=""></span>
                                        <input class="form-control" style="margin-top: 20px; margin-left: 145px;width: 50% " type="text" readonly="" id="kecamatan" value=""></span>
                                        ...
                                        <input class="form-control" style="margin-top: 20px; ;margin-left: 145px;width: 50%" type="text" readonly="" name="surat_cek_kesehatan" id="surat_cek_kesehatan" value="<?php echo $row->surat_cek_kesehatan ?>"></span>
                                        ...
                                        <div class="hr-line-dashed"></div>
                                         ...
                                         <!-- Pisah -->
                                        <label  style="margin-top: 20px;" class="col-sm-2 control-label">Jabatan</label>
                                        <select style="margin-left: 150px; width: 200px" class="form-control m-b" name="status_peserta" id="status_peserta" ">
                                        ...
                                        <span  style="margin-left: 150px;margin-top: 10px" class="help-block m-b-none">(Pilih jabatan peserta KKN)</span>
                                        <div class="hr-line-dashed"></div>

                                        <!-- Pisah -->
                                        <label  style="margin-top: 20px;" class="col-sm-2 control-label">Kelompok</label>
                                        <select style="margin-left: 150px; width: 200px" class="form-control m-b" name="kelompok" id="kelompok" ">
                                            <option selected="selected" disabled="disabled">--Pilih Kelompok--</option>
                                            <?php foreach($kelompok as $kel)
                                        
                                            echo "<option value='".$kel->id_kelompok."'>".$kel->nama_kelompok." (".$kel->kabupaten." , ".$kel->kecamatan." ,".$kel->jenis_kkn.")</option>";
                                            ?>
                                        </select>
                                        <span  style="margin-left: 150px;margin-top: 10px" class="help-block m-b-none">(Pilih Kelompok KKN)</span>
                                        <div class="hr-line-dashed"></div>
                                    </div>
                                    </div>
    ...
    <script type="text/javascript">
        function select_data($id_peserta, $nama_mahasiswa,$nim,$jenis_kkn,$kabupaten,$kecamatan,$surat_cek_kesehatan,$bukti_pendaftaran,$status_peserta){
